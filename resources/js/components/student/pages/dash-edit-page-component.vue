    ...
    export default {
        ...
        created() {
           ...
           // console.log(this.form.group1.css.contain('background'));
            if(this.form.group1.css!=''){
                this.group1_bg='css';
            }

            if(this.form.group2.css!=''){
                this.group2_bg='css';
            }
            if(this.form.group3.css!=''){
                this.group3_bg='css';
            }
            if(this.form.group4.css!=''){
                this.group4_bg='css';
            }
            if(this.form.group5.css!=''){
                this.group5_bg='css';
            }
            if(this.form.group6.css!=''){
                this.group6_bg='css';
            }
            if(this.form.group7.css!=''){
                this.group7_bg='css';
            }
            if(this.form.group8.css!=''){
                this.group8_bg='css';
            }
            if(this.form.group9.css!=''){
                this.group9_bg='css';
            }

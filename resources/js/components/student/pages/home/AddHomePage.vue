...
<p>
مركز ${this.form.group7company} لا يقبل وجود علامات تجارية هنا على هذا الموقع ، هذا يضر بمصلحة الزائر .. و لا يجوز لك عمل اي عملية تهدف الى تسويق علامة تجارية معينة ، الا طبعا اذا استأذنت من صاحب الموقع و وافق هو على ذلك.

</p>


<p>لأي استفسار حول هذه الشروط ، يرجى ارسال ايميل الى <a href="mailto:info@ahmadnahaas.com">info@ahmadnahaas.com</a></p>
...
باستخدام هذا الموقع فإنك تقر أنك قرأت وفهمت، وقبلت، ومن ثم وافقت على الالتزام بهذه الشروط.
                ...
                this.form.post(`${url}/student/pages/homePage/store`).then(() => {
